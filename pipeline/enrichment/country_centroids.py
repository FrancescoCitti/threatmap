# ISO 3166-1 alpha-2 → (latitude, longitude, display_name)
COUNTRIES: dict[str, tuple[float, float, str]] = {
    ...
    "CG": (-0.228021, 15.827659, "Republic of Congo"),
    ...
    "MM": (16.871311, 96.082832, "Myanmar"),
    ...
    "SS": (4.85165, 31.571251, "South Sudan"),
    ...
    "VC": (12.984305, -61.287228, "Saint Vincent"),
...
CENTROIDS: dict[str, tuple[float, float]] = {
    code: (lat, lon) for code, (lat, lon, _) in COUNTRIES.items()
}
NAMES: dict[str, str] = {
    code: name for code, (_, _, name) in COUNTRIES.items()
}
